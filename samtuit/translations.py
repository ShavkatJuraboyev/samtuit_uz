TRANSLATIONS = {
    'menu': { 
        'uz': {
            ...
            'appeal_text':'Ta\'lim grant mablag\'lari uchun qayta taqsmotga ariza topshirish',
            ...
            "center_text":"Filialda jami 18 ta bo‘lim va markazlar mavjud.",
        ...
        'ru': {
            ...
            'students': 'Студенты',
            'apply': 'Подать заявку',
            'appeal_text':'Прием заявок на повторное распределение грантовых средств',
            ...
            "center_text":"Всего в филиале 18 отделов и центров.",
        ...
        'en': {
            ...
            'students': 'Students',
            'apply': 'Apply',
            'appeal_text':'Submit an application for reallocation of educational grant funds',
            ...
            "center_text":"The branch has a total of 18 departments and centers.",
